...
<div class="hero-unit">
    <ul class="breadcrumb">
        ...
        <li class="active">delete expense</li>
    </ul>
    ...
    <p><b>$<?php echo Sanitize::html($total); ?> - <?php echo Sanitize::html($name); ?></b></p>

    <form action="/income/<?php echo Sanitize::html($paycheck_id); ?>/expense/<?php echo Sanitize::html($id); ?>/delete" id="PaycheckExpenseDeleteForm" method="post" accept-charset="utf-8">
